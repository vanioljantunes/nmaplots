...
number of studies in a circle, treatment name plus the event rate written as
fractions (events/n = 21/50 = 42%) at every node, each node's share of all
patients in bold inside the disc, an
